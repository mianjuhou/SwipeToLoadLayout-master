...
public class SwipeToLoadLayout extends ViewGroup {
     ...
     */
    private int mHeaderStyle = STYLE.ABOVE;
    private int mFooterStyle = STYLE.CLASSIC;
    ...
    public SwipeToLoadLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        try {
            ...
            for (int i = 0; i < N; i++) {
                ...
                } else if (attr == R.styleable.SwipeToLoadLayout_swipe_header_style) {
                    setSwipeHeaderStyle(a.getInt(attr, STYLE.CLASSIC));

                }else if (attr == R.styleable.SwipeToLoadLayout_swipe_footer_style) {
                    setSwipeFooterStyle(a.getInt(attr, STYLE.CLASSIC));
...
//        requestLayout();
//    }
    public void setSwipeHeaderStyle(int style) {
        this.mHeaderStyle = style;
        requestLayout();
    }
    public void setSwipeFooterStyle(int style) {
        this.mFooterStyle = style;
        requestLayout();
    }
...
//            }
    ...
    private void layoutChildren() {
        ...
        if (mTargetView != null) {
            ...
            int tempStyle=mHeaderStyle;
            if(mTargetOffset<0){
                tempStyle=mFooterStyle;
            }
            switch (tempStyle) {
                case STYLE.CLASSIC:
                    // classic
        ...
        if (mHeaderStyle == STYLE.CLASSIC
                || mHeaderStyle == STYLE.ABOVE) {
            if (mHeaderView != null) {
                mHeaderView.bringToFront();
            }
            if (mFooterView != null) {
               if(mFooterStyle==STYLE.ABOVE){
                   mFooterView.bringToFront();
               }
            }
        } else if (mHeaderStyle == STYLE.BLEW || mHeaderStyle == STYLE.SCALE) {
            if (mTargetView != null) {
